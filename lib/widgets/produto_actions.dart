                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        buildInfoRow(
                            "Nome do Proprietário: ", widget.product.venda.ownerName),
                        buildInfoRow("Cidade/UF: ", "${widget.product.venda.city}/${widget.product.venda.uf}"),
                        buildInfoRow("Data da NF de Venda: ",
                            DateFormat("dd/MM/yyyy")
